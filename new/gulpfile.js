...
function watchFiles() {
  gulp.watch("./scss/**/*", css);
  gulp.watch("./scss/**/*", browserSyncReload);
  gulp.watch(["./js/**/*", "!./js/**/*.min.js"], js);
  gulp.watch(["./js/**/*", "!./js/**/*.min.js"], browserSyncReload);
...
const watch = gulp.series(build, gulp.parallel(watchFiles, browserSync, browserSyncReload));
